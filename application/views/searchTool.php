...
<html lang="en">
  <head>
	...
	<!-- Include styling files of the search Tool page -->
  ...
  <body>
	...
	<div class="container">
		...
		<!-- Shows the total number of tracked tools on the right -->
		<div class="row">
			...
			<button type="button" class="btn btn-default btn-clear" disabled>
				<span class="glyphicon glyphicon-trash pull-right"></span>Clear All <span class="badge result-amount"></span>
			</button>
			<!-- Filter checkboxs for selecting active or discontinued tools (frameworks) -->
			...
			<!-- Filter checkboxs for filtering tools (frameworks) by technology -->
			<div class="panel-group filter-box">
				<div class="panel panel-default">
					<h4 class="panel-title">
			...
			<!-- Filter checkboxs for filtering tools (frameworks) by supported platform -->
			<div class="panel-group filter-box">
				<div class="panel panel-default">
					<h4 class="panel-title">
			...
			<!-- Filter checkboxs for filtering tools (frameworks) by output product -->
			<div class="panel-group filter-box">
				<div class="panel panel-default">
					<h4 class="panel-title">
			...
			<!-- Filter checkboxs for filtering tools (frameworks) by development language -->
			<div class="panel-group filter-box">
				<div class="panel panel-default">
					<h4 class="panel-title">
			...
			<!-- Filter checkboxs for filtering tools (frameworks) by supported hardware features -->
			<div class="panel-group filter-box">
				<div class="panel panel-default">
					<h4 class="panel-title">
			...
			<!-- Filter checkboxs for filtering tools (frameworks) by license type -->
			<div class="panel-group filter-box">
				<div class="panel panel-default">
					<h4 class="panel-title">
		...
		<!-- Content wrapper for asynchronuously loaded tools (framework) content -->
		<div class="col-sm-9">
			<!-- Bootstrap alert message shown when no tools (frameworks) are visible -->
