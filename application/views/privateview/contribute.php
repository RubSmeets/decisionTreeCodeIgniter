                    ...
                    <div id="frameworkForm" class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div id="formWrapper">
                                ...
                                <form id="frmStep1" data-toggle="validator" role="form" class="form-horizontal container-step1">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Is the tool still activily maintained?</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group has-feedback ">
                                        <label for="inputToolVersion" class="col-xs-4 control-label">Tool's current version</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group has-feedback ">
                                        <label for="inputToolAnnounced" class="col-xs-4 control-label">Year of announcement</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <label for="inputToolTechnology" class="col-xs-4 control-label">The used technology</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group">
                                        <label for="inputToolOutputType" class="col-xs-4 control-label">What type of application can you build with the tool? (*)</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group has-feedback ">
                                        <label for="inputToolUrl" class="col-xs-4 control-label">Website URL</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group has-feedback ">
                                        <label for="inputToolLicense" class="col-xs-4 control-label">License</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Is the tool free to use?</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Is the tool open-source?</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">        
                                        <label class="col-xs-4 control-label">Does the tool provide a trial version?</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">        
                                        <label class="col-xs-4 control-label">Is the tool suited for game development?</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">        
                                        <label class="col-xs-4 control-label">Does the tool provide multiple screen support?</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">        
                                        <label class="col-xs-4 control-label">Does the tool provide prototyping features?</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                ...
                                <form id="frmStep2" data-toggle="validator" role="form" class="form-horizontal container-step2" hidden>                               
                                    <h3>Add Framework resources</h3>
                                    <div class="form-group has-feedback ">
                                        <label for="inputResDocs" class="col-xs-4 control-label">Official documentation</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group has-feedback ">
                                        <label for="inputResBooks" class="col-xs-4 control-label">Available book(s)</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group has-feedback ">
                                        <label for="inputResVideo" class="col-xs-4 control-label">Available video</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group has-feedback ">
                                        <label for="inputResMarket" class="col-xs-4 control-label">Marketplace for components/plugins/etc</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group has-feedback ">
                                        <label for="inputResAppshowcase" class="col-xs-4 control-label">Application gallery</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group has-feedback ">
                                        <label for="inputResTwitter" class="col-xs-4 control-label">Twitter page</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group has-feedback ">
                                        <label for="inputResStackoverflow" class="col-xs-4 control-label">Stackoverflow tagged questions</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group has-feedback ">
                                        <label for="inputResRepo" class="col-xs-4 control-label">Github repository</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-4 control-label">Onsite support available?</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-4 control-label">Hired help available?</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-4 control-label">Phone support available?</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-4 control-label">Time-delayed support available?<div class="help-block">Like email support.</div></label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-4 control-label">Community support available?</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                ...
                                <form id="frmStep3" data-toggle="validator" role="form" class="form-horizontal container-step3" hidden>
                                    <h3>Specify which of the following platforms the tool supports</h3>
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Android</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">iOS</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Blackberry</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Windows Mobile</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Windows Phone</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Windows Universal Platform (WUP)</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Windows</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Mac OSX</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Firefox OS</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Tizen</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Symbian</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Apple TV</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Android TV</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Watch OS</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Bada</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Web OS</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Kindle</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Other Platforms</label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Software Development Kit (SDK)</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">User interface widgets availability</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Support for animation creation</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Publication Assistance</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Livesync during development</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Cloud development options (e.g. cloud-build service)</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Does the tool allow application updates without passing through appstore submission?</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                ...
                                <form id="frmStep4" data-toggle="validator" role="form" class="form-horizontal container-step4" hidden>
                                    <h3>Specify which of the following programming languages the tool uses</h3>
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">HTML</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">CSS</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">JavaScript</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Java</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Objective C</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Swift</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">PHP</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Python</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Ruby</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Basic</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">XML</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">JSX</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">QML</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">LUA</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Actionscript</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Java ME</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">MXML</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">WYSIWYG (visual editor)</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                        ...
                                        <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Other Languages</label>
                                        <div class="col-xs-8">
                                            <div class="input-group short-input">
                                                <span class="input-group-addon">
                                ...
                                <form id="frmStep5" data-toggle="validator" role="form" class="form-horizontal container-step5" hidden>
                                    <h3>Specify which of the following hardware features are supported</h3>
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Accelerometer</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Device</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Bluetooth</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Camera</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Capture</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Geolocation</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Multi-touch Gestures</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Compass</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Connection</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Contacts</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Telephone Messages</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Native Events</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">NFC</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Storage</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Vibration</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Accessibility</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Supports inclusion of Advertisement</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Corporate design and branding</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
                                    ...
                                    <div class="form-group dense-input">
                                        <label class="col-xs-4 control-label">Advanced security</label>
                                        <div class="col-xs-8">
                                            <label class="radio-inline">
